...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"<span class='material-symbols-outlined'> chevron_right </span>",sPrevious:"<span class='material-symbols-outlined'> chevron_left </span>"},sEmptyTable:"No data available in table",sInfo:"Hiển thị _START_ đến _END_ trong _TOTAL_ mục",sInfoEmpty:"Showing 0 to 0 of 0 entries",sInfoFiltered:"(filtered from _MAX_ total entries)",
