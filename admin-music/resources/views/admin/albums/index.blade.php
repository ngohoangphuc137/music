        ...
        <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="card-header-primary shadow-primary-2 border-radius-3 pt-4 pb-3">
                    <h6 class="text-white text-capitalize ps-3">Album</h6>
                </div>
            </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                            ...
                            <div class="add-singer pe-4">
                                <a href="{{ route('albums.create') }}">
                                    <button type="button" class="btn text-end pe-4 py-2 bg-gradient-info" data-bs-toggle="modal" data-bs-target="#exampleModalSignUp"> Thêm Album</button>
                                </a>
                            </div>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        let tableAlbum = $("#table-albums").DataTable({
            responsive: true,
            search: false,
            lengthChange: false,
            autoWidth: false,
