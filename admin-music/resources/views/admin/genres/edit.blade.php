...
@section('titleAdmin')
Danh sách thể loại {{ $genreId->name_genre }}
@endsection
@section('header')
edit {{ $genreId->name_genre }}
@endsection
                ...
                <div class="card">
                    <div class="card-header pb-0 p-3 border-bottom">
                        ...
                        <div class="d-flex align-items-center pb-3">
                            <h5 class="mb-0">Danh sách thể loại {{ $genreId->name_genre }}</h5>
                        </div>

                    </div>
                    <div class="card-body p-3">
                        <form action="{{ route('genres.update',$genreId->id) }}" method="post">
                            @csrf
                            @method('PUT')
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-group input-group-outline my-3">
                                                ...
                                                <input id="name_genre" type="name_genre"
                                                    ...
                                                    name="name_genre" value="{{ $genreId->name_genre }}"
                                                    required
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-group input-group-outline my-3">
                                                ...
                                                <input id="description" type="description" class="form-control"
                                                    name="description" value="{{ $genreId->description }}"
