                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-group input-group-outline my-3">
                                                <label style="width:100%;">Tên ca sĩ</label><br>
                                                <input id="name" type="name"
                                                    class="form-control  @error('name') is-invalid @enderror"
                                                    name="name" value="{{ $artist->name}}" required autocomplete="name">
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-group input-group-outline my-3">
                                                ...
                                                <input id="realname" type="name"
                                                    ...
                                                    name="realname" value="{{ $artist->realname }}" required autocomplete="realname">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-group input-group-static mb-4">
                                                ...
                                                <select class="js-select-country form-control" name="country_id">
                                                    ...
                                                    <option value="{{ $country->id }}" @if ($artist->country_id ==
                                                        $country->id)
                                                        selected
                                                        @endif
                                                        >{{ $country->name }}</option>
...
$(document).ready(function() {
    ...
    let optionCountry = $('.js-select-sex option');
    let optionSelected = optionCountry.filter(function(index, option) {
        return $(option).val() == `{{ $artist->sex }}`
    })
