...
const DefaultLayout = () => {
    ...
    const maxW558px = useMediaQuery({ query: '(max-width:558px)' })
    return (
        <div className="w-full flex relative bg-[#2a1a41]">
            <aside className={`siderBarLeft lg:w-[240px] sm:w-[70px] ${maxW558px ? 'w-[240px] left-slidebar fixed' : ''} z-[100] bg-[#2a1a41]`}>
                <SlideBarLeft />
            </aside>
